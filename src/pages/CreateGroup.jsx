...
export default function CreateGroup() {
    ...
    const [tasks, setTasks] = useState([{ id: 1, name: '알파 프로젝트', email: '' }, { id: 2, name: '베타 프로젝트', email: '' }]);
    ...
    const handleSubmit = () => {
        ...
        if (openImmediately) navigate('/space/1'); else navigate('/');
    };
...
const styles = {
    pageBackground: { backgroundColor: 'var(--bg-color)', minHeight: '100vh', paddingBottom: '60px' },
    header: { backgroundColor: 'rgba(255, 255, 255, 0.95)', borderBottom: '1px solid var(--border-color)', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 40px', position: 'sticky', top: 0, zIndex: 10 },
    headerLeft: { flex: 1 },
    ...
    profileAvatar: { width: '36px', height: '36px', borderRadius: '50%', background: 'linear-gradient(135deg, #6366F1 0%, #9333EA 100%)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '700', fontSize: '14px', fontStyle: 'italic', cursor: 'pointer' },
    mainContainer: { maxWidth: '800px', margin: '40px auto 0' },
    section: { backgroundColor: '#F9FAFB', border: '1px solid var(--border-color)', borderRadius: 'var(--border-radius-md)', padding: '40px' },
    sectionHeader: { borderBottom: '2px solid var(--primary-color)', paddingBottom: '16px', marginBottom: '32px' },
    sectionTitle: { fontSize: '18px', fontWeight: '700', fontStyle: 'italic', color: 'var(--primary-color)', marginBottom: '8px' },
    ...
    input: { width: '100%', padding: '16px', borderRadius: 'var(--border-radius-sm)', border: '1px solid var(--border-color)', fontSize: '15px', backgroundColor: 'var(--white)' },
    addTaskBtn: { width: '100%', padding: '16px', borderRadius: 'var(--border-radius-sm)', border: '2px dashed var(--border-color)', backgroundColor: 'var(--white)', color: 'var(--primary-color)', fontSize: '15px', cursor: 'pointer', textAlign: 'center', marginTop: '4px' },
    emailLabel: { display: 'block', fontSize: '14px', fontWeight: '700', fontStyle: 'italic', color: 'var(--primary-color)', marginBottom: '12px' },
    emailInputWrapper: { display: 'flex', alignItems: 'center', backgroundColor: 'var(--white)', border: '1px solid var(--border-color)', borderRadius: 'var(--border-radius-sm)', padding: '0 16px' },
    ...
    divider: { height: '1px', backgroundColor: 'var(--border-color)', margin: '40px 0' },
    submitArea: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' },
    submitBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '16px 40px', backgroundColor: 'var(--primary-color)', color: 'var(--white)', borderRadius: 'var(--border-radius-sm)', fontSize: '18px', fontWeight: '700', fontStyle: 'italic', cursor: 'pointer' },
    checkboxLabel: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: '#1F2937', cursor: 'pointer' },
    checkbox: { width: '18px', height: '18px', accentColor: 'var(--primary-color)', cursor: 'pointer' },
